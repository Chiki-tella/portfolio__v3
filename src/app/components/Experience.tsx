  ...
  const experiences = [
    {
      ...
      description: 'Developing and maintaining full-stack web applications using modern technologies. Building scalable solutions and collaborating with cross-functional teams to deliver high-quality software products.',
      achievements: ['Built responsive web applications', 'Implemented RESTful APIs', 'Collaborated with design and product teams'],
    ...
    },
    {
      ...
      description: 'Providing custom software development services to clients worldwide. Specializing in web applications, mobile solutions, and system integrations with focus on quality and client satisfaction.',
      achievements: ['Delivered 20+ successful projects', 'Maintained 100% client satisfaction', 'Built diverse portfolio across industries'],
    ...
    },
    {
      ...
      organization: 'College Saint Andre',
      description: 'Participated in an intensive STEM program focused on innovation, technology, and problem-solving. Engaged in hands-on projects and collaborative learning experiences.',
      achievements: ['Completed intensive STEM curriculum', 'Developed innovative project solutions', 'Enhanced technical and teamwork skills'],
